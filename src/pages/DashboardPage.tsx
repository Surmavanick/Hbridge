              ...
              {myBookings.map((booking) => {
                ...
                return (
                  <div key={booking.id} className="bg-white rounded-[20px] border border-border shadow-sm overflow-hidden">
                    ...
                    {/* Flight cost estimate — top 3 cities from patient's country to Tbilisi */}
                    {booking.country && flightEstimates[booking.country] && (
                      <div className="px-6 pb-4">
                        <div className="bg-slate-50 rounded-2xl p-3.5">
                          <div className="flex items-center gap-1.5 mb-2.5">
                            <Plane className="h-3.5 w-3.5 text-blue-500" />
                            <span className="text-[11px] font-semibold text-slate-400 uppercase tracking-wide">
                              Est. Flight to Tbilisi ({booking.country})
                            </span>
                          </div>
